...
from streams.stream import parse_streams, Stream
...
def generate_omnetpp_ini(topology, streams: Dict[int, Stream], emergency_streams, devices, gcls):
    identifier_mapping = []
    pcp_mappings = []
...
if __name__ == "__main__":
    ...
    parser.add_argument('--topology', '-t', help="Topology path", type=str)
    parser.add_argument('--streams', '-s', help="Stream path", type=str)
    parser.add_argument('--emergency_streams', '-e', help="Emergency stream path", type=str)
    parser.add_argument('--transmission', '-m', help="Transmission path", type=str)
    parser.add_argument("--gcl", "-g", help="Path to GCL output", type=str)
